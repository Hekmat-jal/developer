         ...
         <div class="row">
          <div class="col-sm-2 mt-4">
           ...
           <ul id="Side_Menu" class="nav navbar-nav">
               ...
               <li><a href="main.php" class="stylelinks"><img src="images/category.png"  height="35px" alt="">&nbsp;Main Pages</a></li>
               <li><a href="admins.php" class="stylelinks"><img src="images/manageadmin.png"  height="35px" alt="">&nbsp; Manage Admins</a></li>
               <li><a href="./student/profile.php" class="stylelinks"><img src="images/blogs.png"  height="35px" alt="">&nbsp; Profiles</a></li>
               <li><a href="./certificates/index.php" class="stylelinks"><img src="images/comments.png"  height="35px" alt="">&nbsp; Certificates</a></li>
               <li><a href="./student/dashboard.php" class="stylelinks"><img src="images/comments.png"  height="35px" alt="">&nbsp; Student</a></li>
          ...
          <div class="alert alert-primary mt-3 text-center" role="alert">   
            ...
            <table class="table table-striped table-bordered table-hover">
                   <thead class="text-center color-teal">
                    <tr>
                        <th>ایډي</th>
                        <th>یوزر نوم</th>
                        <th>پاسورډ</th>
                   ...
                   <tbody class="text-center color-danger">
                    <tr>
                      <?php 
                        $query="SELECT * FROM users order by addedDate desc";
                    ...
                    <td><a href="updateuser.php?id=<?php echo $id; ?>"><span class="badge bg-success">update</span></a></td>
                    <td><a href="deleteuser.php?id=<?php echo $id; ?>"><span class="badge bg-danger">Delete</span></a></td>
